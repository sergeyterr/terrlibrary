...
if (! class_exists('Inflector')) {
    class Inflector{
         ...
         *      echo Terrlibrary\Inflector::camelize('some_text_here');
         *  </code>
         *
         ...
         *      echo Terrlibrary\Inflector::underscore('SomeTextHere');
         *  </code>
         *
         ...
         *      echo Terrlibrary\Inflector::humanize('some_text_here');
         *  </code>
         *
         ...
         *  <code>
         *      // 1 becomes 1st
         *      echo Terrlibrary\Inflector::ordinalize(1);
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Inflector::pluralize('cat');
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Inflector::singularize('cats');
         *  </code>
         *
