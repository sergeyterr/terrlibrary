...
if (! class_exists('Image')) {
    class Image
    {
         ...
         *
         *  <code>
         *      $image = Terrlibrary\Image::factory('original.png');
         *  </code>
         *
        ...
        protected function createImage($file, $type)
        {
            ...
            switch ($type) {
                ...
                case IMAGETYPE_PNG:
                    ...
                    break;
                default:
                    throw new \RuntimeException(vsprintf("%s(): Unable to open '%s'. Unsupported image type.", array(
                        __METHOD__,
                        $type,
                    )));
            }
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->resize(800, 600)->save('edited.png');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->crop(800, 600, 0, 0)->save('edited.png');
         *  </code>
         *
        ...
        public function watermark($file, $position = null, $opacity = 100)
        {
            ...
            if (! file_exists($file)) {
                throw new \RuntimeException(vsprintf("%s(): The image file ('%s') does not exist.", array(
                    __METHOD__,
                    $file,
                )));
            }
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->grayscale()->save('edited.png');
         *  </code>
         *
         * @return Image
         */
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->sepia()->save('edited.png');
         *  </code>
         *
         * @return Image
         */
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->brightness(60)->save('edited.png');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->colorize(60, 0, 0)->save('edited.png');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->contrast(60)->save('edited.png');
         *  </code>
         *
        ...
        protected function createColor($hex, $alpha = 100, $return_rgb = false)
        {
            ...
            if (preg_match('/^([a-f0-9]{3}){1,2}$/i', $hex) === 0) {
                throw new \RuntimeException(vsprintf("%s(): Invalid color code ('%s').", array(
                    __METHOD__,
                    $hex,
                )));
            }
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->rotate(90)->save('edited.png');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->border('#000', 5)->save('edited.png');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\Image::factory('original.png')->save('edited.png');
         *  </code>
         *
