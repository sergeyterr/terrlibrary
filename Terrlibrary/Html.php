...
if (!class_exists('Html')) {
    class Html
    {
        ...
        public static function arrow($direction)
        {
            switch ($direction) {
                case "up":
                    $output = '<span class="arrow">&uarr;</span>';
                    break;
                case "down":
                    $output = '<span class="arrow">&darr;</span>';
                    break;
                case "left":
                    $output = '<span class="arrow">&larr;</span>';
                    break;
                case "right":
                    $output = '<span class="arrow">&rarr;</span>';
                    break;
                default:
                    $output = '';
            }
         ...
         * @return string
         */
        public static function span($text, array $attributes = null)
        {
         ...
         * @return string
         */
        public static function email($email, $click = false, $text = false)
        {
            $email = str_replace('@', '&#64;', Html::obfuscate($email));
         ...
         * @return string
         */
        public static function phone($phone, $click = false, $text = false)
        {
            if ($click && $text) {
                $title = $text;
            } else {
