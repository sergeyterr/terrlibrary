...
if (! class_exists('Session')) {
    class Session
    {
        protected function __construct()
        {
            ...
            // Дбавление использования сессий
         ...
         *
         *  <code>
         *      Terrlibrary\Session::delete('user');
         *  </code>
         *
         */
         ...
         *
         *  <code>
         *      if (Terrlibrary\Session::exists('user')) {
         *            // Do something...
         *    }
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Session::get('user');
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Session::getSessionId();
         *  </code>
         *
         * @return string
         */
         ...
         *
         *  <code>
         *      Terrlibrary\Session::set('user', 'Awilum');
         *  </code>
         *
