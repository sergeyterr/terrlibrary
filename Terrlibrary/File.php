...
if (! class_exists('File')) {
    class File
    {
         ...
         *
         *  <code>
         *      if (Terrlibrary\File::exists('filename.txt')) {
         *          // Do something...
         *      }
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\File::delete('filename.txt');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\File::rename('filename1.txt', 'filename2.txt');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\File::copy('folder1/filename.txt', 'folder2/filename.txt');
         *  </code>
         *
         * @param  string $from Original file location
         * @param  string $to   Desitination location of the file
         ...
         *
         *  <code>
         *      echo Terrlibrary\File::ext('filename.txt');
         *  </code>
         *
         * @param  string $filename The file name
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\File::name('filename.txt');
         *  </code>
         *
         * @param  string $filename The file name
         *
         ...
         *
         *  <code>
         *      $files = Terrlibrary\File::scan('folder');
         *      $files = Terrlibrary\File::scan('folder', 'txt');
         *      $files = Terrlibrary\File::scan('folder', array('txt', 'log'));
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\File::getContent('filename.txt');
         *  </code>
         *
         * @param  string $filename The file name
         *
         ...
         *
         *  <code>
         *      Terrlibrary\echo File::lastChange('filename.txt');
         *  </code>
         *
         * @param  string $filename The file name
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\File::lastAccess('filename.txt');
         *  </code>
         *
         * @param  string $filename The file name
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\File::mime('filename.txt');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\File::download('filename.txt');
         *  </code>
         *
         ...
         *
         *  <code>
         *      Terrlibrary\File::display('filename.txt');
         *  </code>
         *
         * @param string $file         Full path to file
         * @param string $content_type Content type of the file
         ...
         *
         *  <code>
         *      if (Terrlibrary\File::writable('filename.txt')) {
         *          // do something...
         *      }
         *  </code>
         *
