...
if (! class_exists('Form')) {
    class Form
    {
         ...
         *      echo Terrlibrary\Form::open();
         *
         *      // Form will submit to 'search' using GET
         *      echo Terrlibrary\Form::open('search', array('method' => 'get'));
         *
         *      // When "file" inputs are present, you must include the "enctype"
         *      echo Terrlibrary\Form::open(null, array('enctype' => 'multipart/form-data'));
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::input('username', $username);
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::hidden('user_id', $user_id);
         *  </code>
         *
         * @param string $name       Input name
         * @param string $value      Input value
         ...
         *
         *  <code>
         *     echo Terrlibrary\Form::password('password');
         *  </code>
         *
         * @param string $name       Input name
         * @param string $value      Input value
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::file('image');
         *  </code>
         *
         * @param string $name       Input name
         * @param array  $attributes HTML attributes
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::checkbox('i_am_not_a_robot');
         *  </code>
         *
         * @param string     $name       Input name
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::radio('i_am_not_a_robot');
         *  </code>
         *
         * @param string  $name       Input name
         * @param string  $value      Input value
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::textarea('text', $text);
         *  </code>
         *
         * @param string $name       Name
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::select('themes', array('default', 'classic', 'modern'));
         *  </code>
         *
         * @param string $name       Name
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::submit('save', 'Save');
         *  </code>
         *
         * @param string $name       Input name
         * @param string $value      Input value
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::button('save', 'Save Profile', array('type' => 'submit'));
         *  </code>
         *
         * @param string $name       Input name
         ...
         *
         *  <code>
         *      echo Terrlibrary\Form::label('username', 'Username');
         *  </code>
         *
