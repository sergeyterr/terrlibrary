...
if (! class_exists('Text')) {
    class Text
    {
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::translitIt('Привет');
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::trimSlashes('some text here/');
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::strpSlashes('some \ text \ here');
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::stripQuotes('some "text" here');
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::quotesToEntities('some "text" here');
         *  </code>
         *
         * @param  string $str String with single and double quotes
         *
         ...
         *
         *  <code>
         *      $str = Terrlibrary\Text::increment($str);
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::cut('Some text here', 5);
         *  </code>
         *
        ...
        public static function cut($str, $length, $cut_msg = null)
        {
            ...
            return function_exists('mb_substr') ?
                mb_substr($str, 0, $length, 'utf-8') . $msg :
                substr($str, 0, $length) . $msg;
        }
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::lowercase('Some text here');
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::uppercase('some text here');
         *  </code>
         *
         * @param  string $str String
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::length('Some text here');
         *  </code>
         *
         * @param  string $str String
         *
        ...
        public static function lorem($num = 1)
        {
            ...
            return str_repeat($text, (int) $num);
        }
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::right('Some text here', 4);
         *  </code>
         *
        ...
        public static function right($str, $num)
        {
            ...
            return mb_substr($str, Text::length($str) - $num, $num);
        }
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::left('Some text here', 4);
         *  </code>
         *
         * @param  string  $str The string to extract the characters from.
         * @param  integer $num The number of characters to extract.
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::nl2br("Some \n text \n here");
         *  </code>
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::br2nl("Some <br /> text <br /> here");
         *  </code>
         *
         * @param  string $str The input string
         *
         ...
         *
         *  <code>
         *      echo Terrlibrary\Text::ampEncode("M&CMS");
         *  </code>
         *
         * @param  string $str The input string
         *
         ...
         *
         *    <code>
         *    echo Terrlibrary\Text::toHtml('test');
         *    </code>
         *
         * @param  string $str String
         *
        ...
        /**
         * Terrlibrary\Text::ifecho( $str );
         *
         * @param $str
         */
        public static function ifecho($str)
        {
            if ($str) {
                echo $str;
            }
